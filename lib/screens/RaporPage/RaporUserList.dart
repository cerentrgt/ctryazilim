...
import 'package:kapsul_teknoloji/screens/RaporPage/RaporDetail.dart';
...
class RaporUserList extends StatefulWidget {
  const RaporUserList({super.key});

  @override
  State<RaporUserList> createState() => _RaporUserListState();
}

class _RaporUserListState extends State<RaporUserList> {
  ...
  StreamBuilder _body() {
    return StreamBuilder<QuerySnapshot>(
        stream: firestore.collection("Report").snapshots(),
        ...
        child: ListTile(
            ...
            onTap: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => RaporDetail(post: post)));
            }),
      ),
    );
  }
